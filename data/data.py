...
def get_btc_price(ids, vs_currencies):
    return cg.get_price(ids='{}'.format(ids), vs_currencies='{}'.format(vs_currncies))
...
def SMA_signals(close, sPeriod, lPeriod):
    ...
    return signals_SMA
print('----------------------------------------------')
print(SMA_signals(historic_btc_price.price, 14,49))
...
plotly.offline.plot(return_figures()[3])
